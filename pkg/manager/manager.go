...
func NewVirtletManager(libvirtUri, rawDevices, imageTranslationConfigsDir string, imageStore image.ImageStore, metadataStore metadata.Store, fdManager tapmanager.FDManager) (*VirtletManager, error) {
