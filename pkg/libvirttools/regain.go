...
// RegainNetworkNamespaces scans metadata store for all defined sandboxes
// and tries to recreate their network configuration (with dhcp server in it)
func (v *VirtualizationTool) RegainNetworkNamespaces(fdManager tapmanager.FDManager) (allErrors []error) {
