...
#define DEFINE_VARIABLE(type, func, name, value) \
	type name _cleanup_(func) = value
#define DEFINE_FD(name) DEFINE_VARIABLE(int, cleanupFd, name, -1)
#define DEFINE_VIR_CONNECT(name) \
	DEFINE_VARIABLE(virConnectPtr, cleanupVirConnect, name, NULL)
#define DEFINE_VIR_DOMAIN(name) \
	DEFINE_VARIABLE(virDomainPtr, cleanupVirDomain, name, NULL)
#define DEFINE_VIR_STORAGE_VOL(name) \
	DEFINE_VARIABLE(virStorageVolPtr, cleanupVirStorageVol, name, NULL)
#define DEFINE_VIR_STREAM(name) \
	DEFINE_VARIABLE(virStreamPtr, cleanupVirStream, name, NULL)
