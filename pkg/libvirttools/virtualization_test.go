...
func (ct *containerTester) verifyContainerRootfsExistence(container *kubeapi.Container) bool {
...
func TestContainerLifecycle(t *testing.T) {
	...
	if ct.verifyContainerRootfsExistence(container) {
		t.Errorf("Unexpected remaining rootfs for container %#v", container)
	}
