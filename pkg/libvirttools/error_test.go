...
func TestConvert(t *testing.T) {
	tests := []struct {
		...
		// image.h
		{
			cError:        1000, // VIRTLET_IMAGE_ERR_SEND_STREAM
		...
		{
			cError:        1001, // VIRTLET_IMAGE_ERR_ALREADY_EXISTS
			expectedError: nil,
		},
		{
			cError:        1002, // VIRTLET_IMAGE_ERR_LIBVIRT
			expectedError: GetFakeLibvirtError(),
		},

		// virtualization.h
		{
			cError:        2000, // VIRTLET_VIRTUALIZATION_ERR_LIBVIRT
			expectedError: GetFakeLibvirtError(),
		},
	}
