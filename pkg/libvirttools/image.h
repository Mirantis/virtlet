...
enum virtletImageErr {
	VIRTLET_IMAGE_ERR_SEND_STREAM = VIRTLET_IMAGE_ERR_BASE,
	VIRTLET_IMAGE_ERR_ALREADY_EXISTS = VIRTLET_IMAGE_ERR_BASE + 1,
	VIRTLET_IMAGE_ERR_LIBVIRT = VIRTLET_IMAGE_ERR_BASE + 2,
};
