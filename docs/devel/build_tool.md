...
the data volumes if they don't exist, then copy the local sources
into `virtlet_src` data volume.
...
Runs unit tests suite in build container - suitable for connecting with
IDEs/editors.
