...
const (
	defaultLiteImageLocation  = "download.cirros-cloud.net/0.3.5/cirros-0.3.5-x86_64-disk.img"
	defaultHeavyImageLocation = "github.com/mirantis/virtlet/releases/download/v0.8.2/cirros.img"
