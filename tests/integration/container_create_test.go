...
func TestContainerCreateStartListRemove(t *testing.T) {
	...
	sandboxes[0].Annotations["VirtletVolumes"] = `[{"Name": "vol1"}, {"Name": "vol2", "Format": "qcow2", "Capacity": "2048", "CapacityUnit": "MB"}, {"Name": "vol3"}]`
	sandboxes[1].Annotations["VirtletVolumes"] = `[{"Name": "vol1", "Format": "qcow2", "CapacityUnit": "GB"}, {"Name": "vol2", "Capacity": "2048"}]`
